...
var oJ=_mz(z,'view',['class',-1,'bindtap',6,'data-event-opts',1,'data-newsid',2,'hoverClass',3],[],hG,cF,gg)
var lK=_n('view')
...
var cW=_mz(z,'rich-text',['class',3,'nodes',1],[],e,s,gg)
_(oV,cW)
_(fS,oV)
_(r,fS)
return r
